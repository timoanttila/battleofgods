	...
	<div id="wrap" class="flex">
		...
		<footer class="bg-primary block">
			<div class="container mx-auto px text-center text-white">
				<p><small>Created by <a class="text-white" href="https://timoanttila.com/" title="Full Stack Web Developer Timo Anttila">Timo Anttila</a>, <a class="text-white" href="https://tuspe.com/">Tuspe Design Oy</a></small><br>
